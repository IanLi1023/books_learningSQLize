...
// endpoint is a PATCH request to update a user by their primary key, this should respond back with the updated user data
//endpoint is a DELETE request to delete a user by their primary key, this should respond back with the deleted user data
